        ...
        public function empList(){
           ...
           $sqlResult = $this->dbResult->query($sqlSelect);
            ...
            if($nor > 0){
              ...
              else if($rec['emp_JobTitle'] == "OIC(Office in charge)")
                {$badge ='<span class="badge bg-success">OIC(Office in charge)</span>';}
                  ...
                  <tr>
                    ...
                    <td>'.$rec['emp_Phone'].'</td>
                    <td>'.$badge.'</td>
                    <td><button type="button" onclick="editemp(\''.$rec['emp_Id'].'\');"  class="btn btn-warning px-2 mx-2">Edit
                    </button>    <button type="button" class="btn btn-danger px-2 mx-2" onclick="deleteemp(\''.$rec['emp_Id'].'\')">Delete</button></td>
                 </tr>
                        ');
              }
            }

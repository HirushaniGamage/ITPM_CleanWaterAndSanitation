...
<div class="no-print">
        ...
        <div class="form-group row">
                <div class="col-3 py-3 px-4">
                    <label>Select Region and Month</label>
                </div>
...
<div class="container" style="background-color:white;  color: black;">
    ...
    <h2 class="py-3" style="text-align:center">Region-wise Monthly Report</h2>
    ...
    <table class="center mt-5" style="text-align:center; width:80%; border: 1px solid;margin-left: auto; margin-right: auto;">
        ...
        <tbody>
        <tr>
            <td style="text-align:left;">Plant Count</td>
            <td id="011"></td>
        </tr>
        <tr>
            <td style="text-align:left;">Plant Names</td>
            <td id="01"></td>
        </tr>
        <tr>
...
$(document).on('click', '#genarate', function (e) {
       ...
       {
        getdetails($region, $month);
    }
    });

function getdetails($region,$month){
        $.get("../../routes/invoice/getregonrecdata.php", {
                region: $region,
                month: $month
            }, function (res) {
